...
@router.get("/schedule/team/{team_id}", response_model=MeetingScheduleRead)
...
@router.post("/schedule/", response_model=MeetingScheduleRead, status_code=status.HTTP_201_CREATED)
...
@router.patch("/schedule/{schedule_id}", response_model=MeetingScheduleRead)
